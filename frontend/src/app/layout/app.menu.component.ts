					  ...
					  },
					  {
						...
						items: [
								  ...
								  },
								  {
									...
									icon: 'pi pi-fw pi-plus-circle',
									routerLink: ['/app/admin/collaborator/inscription-collaborator/list']
								  },
								  {
					  ...
					  },
					  {
						...
						items: [
								  ...
								  },
								  {
									...
									icon: 'pi pi-fw pi-plus-circle',
									routerLink: ['/app/admin/collaborator/paiment-collaborator-state/list']
								  },
						]
					  },
					  {
					  ...
					  },
					  {
						...
						items: [
								  ...
								  },
								  {
									label: 'Liste inscription collaborator',
									icon: 'pi pi-fw pi-plus-circle',
									routerLink: ['/app/collaborator/collaborator/inscription-collaborator/list']
								  },
								  {
									label: 'Liste paiment collaborator type',
									icon: 'pi pi-fw pi-plus-circle',
					  ...
					  },
					  {
						...
						items: [
								  ...
								  },
								  {
									label: 'Liste paiment collaborator state',
									icon: 'pi pi-fw pi-plus-circle',
									routerLink: ['/app/collaborator/collaborator/paiment-collaborator-state/list']
								  },
						]
					  },
					  {
