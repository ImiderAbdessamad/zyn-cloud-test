                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CityListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CollaboratorListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CountryListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class CollaboratorAdminRoutingModule { }
