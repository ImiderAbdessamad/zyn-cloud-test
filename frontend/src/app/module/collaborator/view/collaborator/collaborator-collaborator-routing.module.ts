                    ...
                    children: [
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CityListCollaboratorComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CollaboratorListCollaboratorComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: CountryListCollaboratorComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class CollaboratorCollaboratorRoutingModule { }
