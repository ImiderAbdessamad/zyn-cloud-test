...
@Component({
  selector: 'app-paiment-collaborator-create-collaborator',
  templateUrl: './paiment-collaborator-create-collaborator.component.html'
})
export class PaimentCollaboratorCreateCollaboratorComponent  implements OnInit {
