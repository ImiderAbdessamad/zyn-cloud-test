...
import {InscriptionCollaboratorDto} from 'src/app/shared/model/collaborator/InscriptionCollaborator.model';
import {InscriptionCollaboratorCollaboratorService} from 'src/app/shared/service/collaborator/collaborator/InscriptionCollaboratorCollaborator.service';

@Component({
  selector: 'app-paiment-collaborator-edit-collaborator',
  templateUrl: './paiment-collaborator-edit-collaborator.component.html'
})
export class PaimentCollaboratorEditCollaboratorComponent implements OnInit {
 ...
 public edit(): void {
   ...
   public async openCreatePaimentCollaboratorType(paimentCollaboratorType: string) {
        const isPermistted = await this.roleService.isPermitted('PaimentCollaboratorType', 'edit');
        if (isPermistted) {
