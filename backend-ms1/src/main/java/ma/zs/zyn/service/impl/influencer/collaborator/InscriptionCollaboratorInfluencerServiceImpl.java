...
import ma.zs.zyn.service.facade.influencer.packaging.PackagingPlanInfluencerService ;
import ma.zs.zyn.bean.core.packaging.PackagingPlan ;

import java.util.List;
@Service
public class InscriptionCollaboratorInfluencerServiceImpl implements InscriptionCollaboratorInfluencerService {
    ...
    @Autowired
    private PackagingPlanInfluencerService packagingPlanService ;

    public InscriptionCollaboratorInfluencerServiceImpl(InscriptionCollaboratorDao dao) {
        this.dao = dao;
    }
