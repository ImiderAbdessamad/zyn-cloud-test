package ma.zs.zyn.service.impl.agent.collaborator;
...
import java.util.List;
@Service
public class PaimentCollaboratorStateAgentServiceImpl implements PaimentCollaboratorStateAgentService {
    ...
    public PaimentCollaboratorStateAgentServiceImpl(PaimentCollaboratorStateDao dao) {
        this.dao = dao;
    }
