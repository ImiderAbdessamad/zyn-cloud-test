package ma.zs.zyn.service.impl.influencer.payement;
...
import ma.zs.zyn.service.facade.influencer.payement.PaimentCollaboratorInfluencerService;
...
import ma.zs.zyn.service.facade.influencer.collaborator.PaimentCollaboratorStateInfluencerService ;
import ma.zs.zyn.bean.core.collaborator.PaimentCollaboratorState ;
import ma.zs.zyn.service.facade.influencer.payement.PaimentCollaboratorTypeInfluencerService ;
import ma.zs.zyn.bean.core.payement.PaimentCollaboratorType ;
import ma.zs.zyn.service.facade.influencer.packaging.PackagingInfluencerService ;
...
import ma.zs.zyn.service.facade.influencer.collaborator.InscriptionCollaboratorInfluencerService ;
import ma.zs.zyn.bean.core.collaborator.InscriptionCollaborator ;

import java.util.List;
@Service
public class PaimentCollaboratorInfluencerServiceImpl implements PaimentCollaboratorInfluencerService {
    ...
    @Autowired
    private OffreCloudProviderInfluencerService offreCloudProviderService ;
    @Autowired
    private PaimentCollaboratorStateInfluencerService paimentCollaboratorStateService ;
    @Autowired
    private PaimentCollaboratorTypeInfluencerService paimentCollaboratorTypeService ;
    @Autowired
    private PackagingInfluencerService packagingService ;
    @Autowired
    private CountryInfluencerService countryService ;
    @Autowired
    private CityInfluencerService cityService ;
    @Autowired
    private InscriptionCollaboratorInfluencerService inscriptionCollaboratorService ;

    public PaimentCollaboratorInfluencerServiceImpl(PaimentCollaboratorDao dao) {
        this.dao = dao;
    }
