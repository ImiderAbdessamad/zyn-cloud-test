...
import ma.zs.zyn.service.facade.agent.payement.PaimentCollaboratorAgentService;
...
import ma.zs.zyn.service.facade.agent.coupon.CouponAgentService ;
import ma.zs.zyn.bean.core.coupon.Coupon ;
import ma.zs.zyn.service.facade.agent.cloud.OffreCloudProviderAgentService ;
import ma.zs.zyn.bean.core.cloud.OffreCloudProvider ;
import ma.zs.zyn.service.facade.agent.collaborator.PaimentCollaboratorStateAgentService ;
...
import ma.zs.zyn.service.facade.agent.packaging.PackagingAgentService ;
import ma.zs.zyn.bean.core.packaging.Packaging ;
import ma.zs.zyn.service.facade.agent.collaborator.CountryAgentService ;
import ma.zs.zyn.bean.core.collaborator.Country ;
import ma.zs.zyn.service.facade.agent.collaborator.CityAgentService ;
import ma.zs.zyn.bean.core.collaborator.City ;
import ma.zs.zyn.service.facade.agent.collaborator.InscriptionCollaboratorAgentService ;
import ma.zs.zyn.bean.core.collaborator.InscriptionCollaborator ;

import java.util.List;
@Service
public class PaimentCollaboratorAgentServiceImpl implements PaimentCollaboratorAgentService {
    ...
    @Autowired
    private CouponAgentService couponService ;
    @Autowired
    private OffreCloudProviderAgentService offreCloudProviderService ;
    @Autowired
    private PaimentCollaboratorStateAgentService paimentCollaboratorStateService ;
    @Autowired
    private PaimentCollaboratorTypeAgentService paimentCollaboratorTypeService ;
    @Autowired
    private PackagingAgentService packagingService ;
    @Autowired
    private CountryAgentService countryService ;
    @Autowired
    private CityAgentService cityService ;
    @Autowired
    private InscriptionCollaboratorAgentService inscriptionCollaboratorService ;

    public PaimentCollaboratorAgentServiceImpl(PaimentCollaboratorDao dao) {
        this.dao = dao;
    }
