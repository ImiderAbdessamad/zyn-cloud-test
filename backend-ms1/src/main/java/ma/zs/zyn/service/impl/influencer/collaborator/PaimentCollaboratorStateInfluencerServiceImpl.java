...
import java.util.List;
@Service
public class PaimentCollaboratorStateInfluencerServiceImpl implements PaimentCollaboratorStateInfluencerService {
    ...
    public PaimentCollaboratorStateInfluencerServiceImpl(PaimentCollaboratorStateDao dao) {
        this.dao = dao;
    }
