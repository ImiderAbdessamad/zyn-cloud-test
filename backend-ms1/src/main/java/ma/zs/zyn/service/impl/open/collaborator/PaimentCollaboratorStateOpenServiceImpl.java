...
import java.util.List;
@Service
public class PaimentCollaboratorStateOpenServiceImpl implements PaimentCollaboratorStateOpenService {
    ...
    public PaimentCollaboratorStateOpenServiceImpl(PaimentCollaboratorStateDao dao) {
        this.dao = dao;
    }
