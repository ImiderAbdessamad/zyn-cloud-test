package ma.zs.zyn.service.impl.open.collaborator;
...
import ma.zs.zyn.service.facade.open.packaging.PackagingPlanOpenService ;
import ma.zs.zyn.bean.core.packaging.PackagingPlan ;

import java.util.List;
@Service
public class InscriptionCollaboratorOpenServiceImpl implements InscriptionCollaboratorOpenService {
    ...
    public void findOrSaveAssociatedObject(InscriptionCollaborator t){
        if( t != null) {
            t.setPackagingPlan(packagingPlanService.findOrSave(t.getPackagingPlan()));
        }
    }
    ...
    @Autowired
    private PackagingPlanOpenService packagingPlanService ;

    public InscriptionCollaboratorOpenServiceImpl(InscriptionCollaboratorDao dao) {
        this.dao = dao;
    }
