package  ma.zs.zyn.ws.facade.collaborator.collaborator;
...
public class PaimentCollaboratorStateRestCollaborator {
   ...
   public PaimentCollaboratorStateRestCollaborator(PaimentCollaboratorStateCollaboratorService service, PaimentCollaboratorStateConverter converter){
        this.service = service;
        this.converter = converter;
    }

    private final PaimentCollaboratorStateCollaboratorService service;
    private final PaimentCollaboratorStateConverter converter;
