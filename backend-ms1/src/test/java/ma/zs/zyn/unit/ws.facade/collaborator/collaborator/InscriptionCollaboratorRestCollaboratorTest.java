...
import ma.zs.zyn.service.impl.collaborator.collaborator.InscriptionCollaboratorCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.collaborator.InscriptionCollaboratorRestCollaborator;
...
public class InscriptionCollaboratorRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private InscriptionCollaboratorCollaboratorServiceImpl service;
    @Mock
    private InscriptionCollaboratorConverter converter;

    @InjectMocks
    private InscriptionCollaboratorRestCollaborator controller;
