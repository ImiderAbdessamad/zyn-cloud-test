...
import ma.zs.zyn.service.impl.collaborator.collaborator.PaimentCollaboratorStateCollaboratorServiceImpl;
import ma.zs.zyn.ws.facade.collaborator.collaborator.PaimentCollaboratorStateRestCollaborator;
import ma.zs.zyn.ws.converter.collaborator.PaimentCollaboratorStateConverter;
import ma.zs.zyn.ws.dto.collaborator.PaimentCollaboratorStateDto;
...
public class PaimentCollaboratorStateRestCollaboratorTest {

    private MockMvc mockMvc;

    @Mock
    private PaimentCollaboratorStateCollaboratorServiceImpl service;
    @Mock
    private PaimentCollaboratorStateConverter converter;

    @InjectMocks
    private PaimentCollaboratorStateRestCollaborator controller;
